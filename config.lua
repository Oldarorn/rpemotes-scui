Config = {
    ...
    Framework = 'esx', -- Used for few framework-dependent things. Accepted values: 'qb-core', 'esx' or false
...
Config.Credits = {
    ...
    {title = "Thanks <font color=\"#008C45\">Manups4e 🇮🇹 </font>", subtitle = "<font color=\"#008C45\">Manups4e 🇮🇹 </font> for creating ScaleformUI"},
